          ...
          <div className="hero-content flex flex-col text-center">
            ...
            <div>
              <a
                ...
                target="_blank"
              >
                <button className="lg:px-18 group btn relative my-16 h-12 overflow-hidden rounded-xl border-0 bg-white px-4 transition-all hover:bg-white md:px-12 lg:h-16">
