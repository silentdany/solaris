const InnerSectionBlock = ({ children, bgColor }) => (
  <div
    className={`w-full border-t-8 border-primary-700 bg-gradient-to-b ${bgColor} relative flex justify-center overflow-hidden to-transparent p-8 pb-16 md:p-16 md:pb-32`}
  >
