...
export const resources = [
  {
    ...
    list: [
      ['Développement technologique', 'Montage vidéo', 'Gestion de projet'],
      ['Journalisme web', 'Ressources humaines', 'Juridique'],
      ['Investissement', 'Entreprenariat', 'Trading'],
    ],
  },
  {
    type: 'Team',
    ...
    list: [
      ['Développement d’outils techniques Web3', 'Création de sites internet'],
      ['Réalisation de trailers', 'Réalisation d’animations et de Lives'],
      [
